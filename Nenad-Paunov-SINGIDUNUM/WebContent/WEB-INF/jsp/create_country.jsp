...
<script src="${pageContext.request.contextPath}/static/js/country.js"></script>
		...
		<div id="main">
			...
			<div id="wrap">
				...
				<div id="wrap2">
					...
					<h2 class="free_account">Create country</h2>
					...
					<form action="${pageContext.request.contextPath }/docreatecountry"
						...
						<p>
							<label for="country">Country name</label> <input name="name"
								type="text" placeholder="Country name(Required)" minlength="2"
								maxlength="30" /> <span class="val_country"></span>
						</p>

						<input type="submit" name="submit" value="Create new country">
					</form>
