...
<script type="text/javascript">
	function confirmDelete(x) {
	      var r = confirm("Are you sure about deleting this subject?");
	      if (r == true) {
	          window.location.pathname = "${pageContext.request.contextPath}/dodeletesubject/"+x;
	      }	   
	    }
</script>
</head>
				...
				<div class="table-wrapper">
					<div class="table-title">
						<div class="row">
							...
							<div class="col-sm-4">
								<a href="${pageContext.request.contextPath }/create_subject"
							...
							<tr>
								<c:forEach var="tempSubject" items="${subjects}">
									<tr>
										...
										<td><a
											href="${pageContext.request.contextPath }/subject_details/${tempSubject.subjectId}"
											target="_self" class="fullscreen" title="See all details"
											data-toggle="tooltip"><i class="material-icons">&#xE03B;</i></a>
										</td>
										<td><a
											href="${pageContext.request.contextPath}/doupdatesubject/${tempSubject.subjectId}"
											class="edit" title="Edit" data-toggle="tooltip"><i
												class="material-icons">&#xE254;</i></a></td>
										<td><a class="
									delete" title="Delete"
											data-toggle="tooltip"
											onclick="confirmDelete(${tempSubject.subjectId})"><i
												class="material-icons">&#xE872;</i></a></td>
									</tr>
								</c:forEach>
