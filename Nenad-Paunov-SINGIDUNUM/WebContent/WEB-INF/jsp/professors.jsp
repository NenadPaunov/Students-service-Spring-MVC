...
<script type="text/javascript">
	function confirmDelete(x) {
	      var r = confirm("Are you sure about deleting this professor?");
	      if (r == true) {
	          window.location.pathname = "${pageContext.request.contextPath}/dodeleteprofessor/"+x;
	      }	   
	    }
</script>
</head>
			...
			<div class="container">
				<div class="table-wrapper">
							...
							<tr>
								<c:forEach var="tempProfessor" items="${professors}">
									<tr>
										...
										<td><a
											href="${pageContext.request.contextPath }/professor_details/${tempProfessor.id}"
											target="_self" class="fullscreen" title="See all details"
											data-toggle="tooltip"><i class="material-icons">&#xE03B;</i></a>
										</td>
										<td><a
											href="${pageContext.request.contextPath}/doupdateprofessor/${tempProfessor.id}"
											class="
									...
									delete" title="Delete"
											data-toggle="tooltip"
											onclick="confirmDelete(${tempProfessor.id})"><i
												class="material-icons">&#xE872;</i></a></td>
									</tr>
								</c:forEach>
					...
					<c:forEach var="i" begin="1" end="${pages }" step="1">
						<a
							href="${pageContext.request.contextPath}/professors/${i}/${num}">${i}</a>
					</c:forEach>
				</div>
			</div>
