		...
		<div id="main">
			...
			<div id="wrap">
				...
				<div id="wrap2">
					...
					<h2 class="free_account">Update title</h2>

					<form action="${pageContext.request.contextPath }/updatetitle/${title.titleId}"
						method="post" id="register_form">

						<p class="validate_msg">Please fix the errors below!</p>

						<p>
							<label for="titleName">Title</label> <input
								name="titleName" type="text"
								placeholder="Title(Required)" value="${title.titleName}"  minlength="2" maxlength = "30"/> <span
								class="val_titleName"></span>
						</p>
