...
<script type="text/javascript">
	function confirmDelete(x) {
	      var r = confirm("Are you sure about deleting this city?");
	      if (r == true) {
	          window.location.pathname = "${pageContext.request.contextPath}/dodeletecity/"+x;
	      }	   
	    }
</script>
</head>
				...
				<div class="table-wrapper">
					<div class="table-title">
						<div class="row">
							...
							<div class="col-sm-4">
								<a href="${pageContext.request.contextPath }/create_city"
							...
							<tr>
								<c:forEach var="tempCity" items="${cities}">
									<tr>
										...
										<td><a
											href="${pageContext.request.contextPath}/doupdatecity/${tempCity.cityId}"
											class="edit" title="Edit" data-toggle="tooltip"><i
												class="material-icons">&#xE254;</i></a></td>
										<td><a class="
									delete" title="Delete"
											data-toggle="tooltip"
											onclick="confirmDelete(${tempCity.cityId})"><i
												class="material-icons">&#xE872;</i></a></td>
									</tr>
								</c:forEach>
