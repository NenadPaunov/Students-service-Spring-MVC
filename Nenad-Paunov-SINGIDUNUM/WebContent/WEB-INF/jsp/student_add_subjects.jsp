...
<title>Adding subjects to student</title>
		...
		<div id="main">
			...
			<div id="wrap">
				...
				<div id="wrap2">
					...
					<h2 class="free_account">Add subjects</h2>

					<form
						action="${pageContext.request.contextPath }/addsubject/${student.id}"
						...
						<p></p>
						<p>
							<label for="subjects">Subjects</label> <select name="list"
								multiple>
						...
						<input type="submit" name="submit" value="Add subjects">
					</form>
