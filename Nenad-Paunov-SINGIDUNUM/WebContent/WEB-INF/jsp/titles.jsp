...
<script type="text/javascript">
	function confirmDelete(x) {
	      var r = confirm("Are you sure about deleting this title?");
	      if (r == true) {
	          window.location.pathname = "${pageContext.request.contextPath}/dodeletetitle/"+x;
	      }	   
	    }
</script>
</head>
				...
				<div class="table-wrapper">
					<div class="table-title">
						<div class="row">
							...
							<div class="col-sm-4">
								<a href="${pageContext.request.contextPath }/create_title"
							...
							<tr>
								<c:forEach var="tempTitle" items="${titles}">
									<tr>
										...
										<td><a
											href="${pageContext.request.contextPath}/doupdatetitle/${tempTitle.titleId}"
											class="edit" title="Edit" data-toggle="tooltip"><i
												class="material-icons">&#xE254;</i></a></td>
										<td><a class="
									delete" title="Delete"
											data-toggle="tooltip"
											onclick="confirmDelete(${tempTitle.titleId})"><i
												class="material-icons">&#xE872;</i></a></td>
									</tr>
								</c:forEach>
					...
					<c:forEach var="i" begin="1" end="${pages }" step="1">
						<a href="${pageContext.request.contextPath}/titles/${i}/${num}">${i}</a>
					</c:forEach>
				</div>
			</div>
               ...
               function() {
                   document
                           ...
                           .addEventListener(
                                   "change",
                                   function(e) {
                                       window.location.href = "${pageContext.request.contextPath}/titles/1/"
                                               + document
