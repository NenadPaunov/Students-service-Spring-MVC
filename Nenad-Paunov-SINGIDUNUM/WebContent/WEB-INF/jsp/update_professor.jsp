		...
		<div id="main">
			...
			<div id="wrap">
				...
				<div id="wrap2">
					...
					<h2 class="free_account">Update professor</h2>

					<form action="${pageContext.request.contextPath }/updateprofessor/${professor.id}"
						...
						<p>
							<label for="fname">First name</label> <input name="firstName"
								type="text" placeholder="First name(Required)" value="${professor.firstName}" minlength="3" maxlength = "30"/> <span
								class="val_fname"></span>
						</p>
						<p>
							<label for="lname">Last Name</label> <input name="lastName"
								type="text" placeholder="Last name(Required)" value="${professor.lastName}" minlength="3" maxlength = "30"/> <span
								class="val_lname"></span>
						</p>
						<p>
							<label for="email">Email</label> <input name="email" type="text"
								placeholder="name@gmail.com(Required)" value="${professor.email}"  maxlength = "30"/> <span
								class="val_email"></span>
						</p>
						<p>
							<label for="address">Address</label> <input name="address"
								type="text" placeholder="Address(Required)" value="${professor.address}" minlength="3" maxlength = "50"/> <span
								class="val_address"></span>
						</p>
						<p>
							<label for="phone">Phone number</label> <input name="phone"
								type="text" placeholder="(XXX)XXX-XXXX(Required)" value="${professor.phone}" minlength="6" maxlength = "15"/> <span
						...
						<input type="submit" name="submit" value="Update professor">
					</form>
