		...
		<div id="main">
			...
			<div id="wrap">
				...
				<div id="wrap2">
					...
					<form
						action="${pageContext.request.contextPath }/updateprofessor/${professor.id}"
						...
						<p>
							<label id="reelectionDate" for="reelectionDate">Re-election
								...
								max="2030-04-20" required value="${professor.reelectionDate}" />
							<span class="val_reelectionDate"></span>
						</p>
						<p>
						...
						<p>
							<label for="city">Title</label> <select name="titleId">
