		...
		<div id="main">
			...
			<div id="wrap">
				...
				<div id="wrap2">
					...
					<h2 class="free_account">Create city</h2>
					...
					<form action="${pageContext.request.contextPath }/docreatecity"
						...
						<input type="submit" name="submit" value="Create new city">
					</form>
